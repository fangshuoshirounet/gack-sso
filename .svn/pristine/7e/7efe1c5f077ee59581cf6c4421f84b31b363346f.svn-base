        ...
        <div class="easyui-layout" data-options="fit:true">
          ...
          <div data-options="region:'north'" class="search">
            ...
            <div data-options="region:'south'" class="buttons">
         	    <shiro:hasPermission name="security:applyrole:pended:view">
...
$(function() { 
	$("#flexTable").flexigrid({
			...
			colModel : [
							...
							align: 'center',
							operateColumn: [
								            {html: '<shiro:hasPermission name="security:applyrole:pended:view"><a  name="showLink" href="#">查看</a></shiro:hasPermission>'}
										   ]
						}]
		});
	    //查询
		...
		//查看
			...
			var key=getSelected({nameGroup:'id',currentObj:$(this)});
			 ...
			 top.openDialog({href:url,resizable : false,height: 330,width: 654,title: "查看角色",modal : true});
			}
		});
