    ...
    <div data-options="region:'center'" class="no-border">
        <div class="easyui-layout" data-options="fit:true">
                        ...
                        <table class="search-table">
                            <tr>
								...
								<td class="search-buttons">
									<shiro:hasPermission name="security:applyuserrole:pended:query">
            ...
            <div data-options="region:'south'" class="buttons">
         	    <shiro:hasPermission name="security:applyuserrole:pended:view">
...
$(function() { 
	$("#flexTable").flexigrid({
			...
			colModel : [
							...
							align: 'center',
							operateColumn: [
								            {html: '<shiro:hasPermission name="security:applyuserrole:pended:view"><a  name="showLink" href="#">查看</a></shiro:hasPermission>'}
										   ]
						}]
		});
	    //查询
