					...
					for (var i = 0; i < rowData.length; i++) {
						...
						if (p.checkbox) {
							...
							if (!p.singleSelect) {
								...
								cthch = $('<input style="width:20px;" type="radio" value="'
										+ $(tr).attr('id') + '"/>');
							}
...
/*			html += '<div class="pGroup" title="刷新" style="margin-right:5px;"> <div class="pReload pButton"><span></span></div> </div><div class="btnseparator"></div>';
*/			
			html += '';
			if (p.toExcel) {
