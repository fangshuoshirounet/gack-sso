	...
	$('#menuCatalogTree').tree({
		...
		onCheck:function(node,checked){
			if(checked){
				...
				var loadurl= '${ctx_admin}/security/sysUserpermission/searchMenuCatalogConstraint?menuCatalogId='+node.id+"&sysUserId="+sysUserId+"&random="+random;
    ...
    <div data-options="region:'center'" class="no-border">
        <div class="easyui-layout" data-options="fit:true">
            ...
            <div data-options="region:'south'" class="buttons">
				...
				<input type="button" class="button" id="menucatalogConstraintBtn" value="保 存"/>
            </div>
        </div>
    </div>
</div>  
...
$('#menucatalogConstraintForm').ajaxForm({
    url:"${ctx_admin}/security/sysUserpermission/saveMenuCatalogConstraint",
