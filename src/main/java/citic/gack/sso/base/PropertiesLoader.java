...
public class PropertiesLoader {
    ...
    private Properties loadProperties(String... resourcesPaths) {
        ...
        for (String location : resourcesPaths) {
            ...
            logger.debug(String.format("Loading properties file from path:%s", location));
            ...
            try {
                ...
                logger.error(String.format("Could not load properties from path:%s, %s ", location, ex.getMessage()));
            } finally {
                try {
                	if(is!=null){
                		is.close();
