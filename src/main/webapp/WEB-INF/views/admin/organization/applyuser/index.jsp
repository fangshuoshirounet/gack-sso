	...
	<div data-options="region:'center'" class="no-border">
		<div class="easyui-layout" data-options="fit:true">
			...
			<div data-options="region:'south'" class="buttons"> 
				...
				<shiro:hasPermission name="check:user:view"><input type="button" class="button" id="showBtn" value="查看" /></shiro:hasPermission>
				<shiro:hasPermission name="check:user:edit">	<input type="button" class="button" id="accessBtn" value="通过" />
...
<script type="text/javascript">
	...
	$("#showBtn,[name='showLink']").live("click", function(event, data) {
		if (isSelected({
			...
			var url = '${ctx_admin}/organization/applyuser/' + key + '/edit';
			top.openDialog({
				href : url,
				resizable : false,
				height : 430,
	...
	$("#okBtn").click(function() {
		...
		var url = "${ctx_admin}/organization/applyuser/review/" + keys;
	 	$.ajax({
			type : 'post',
			url : url,
			data : {
