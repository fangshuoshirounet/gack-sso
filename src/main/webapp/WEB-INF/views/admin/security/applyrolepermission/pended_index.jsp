        ...
        <div class="easyui-layout" data-options="fit:true">
          ...
          <div data-options="region:'north'" class="search">
            ...
            <div data-options="region:'south'" class="buttons">
         	    <shiro:hasPermission name="security:applyrolepermission:pended:view">
...
$(function() { 
	$("#flexTable").flexigrid({
			...
			colModel : [
							...
							align: 'center',
							operateColumn: [
								            {html: '<shiro:hasPermission name="security:applyrolepermission:pended:view"><a  name="showLink" href="#">查看</a></shiro:hasPermission>'}
										   ]
						}]
		});
	    //查询
		...
		var key=getSelected({nameGroup:'id',currentObj:$(this)});
		 ...
		 top.openDialog({href:url,resizable : false,height: 700,width: 654,title: "查看角色",modal : true});
		}
	});
	});
